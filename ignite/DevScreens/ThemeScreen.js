...
export default class ThemeScreen extends React.Component {
  ...
  renderStyle(fontStyle: string) {
    return (
      <Text style={[styles.fontRow, {...Fonts.style[fontStyle]}]} key={fontStyle}>{`This is ${fontStyle} style`}</Text>)
  }
      ...
      <View style={styles.mainContainer}>
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.section} key='colors-header'>
            <Text style={styles.sectionText} key='colors'>List of Theme specific settings. Auto-generated from Themes
              folder.</Text>
          </View>
